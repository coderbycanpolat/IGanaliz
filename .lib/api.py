...
def user_info(usrname):
	...
	usrinfo = {
		'KULLANICI ADI': js['username'],
		'KULLANICI İD': js['id'],
		'İSİM': js['full_name'],
		'TAKİPÇİ SAYISI': js['edge_followed_by']['count'],
		'TAKİP SAYISI': js['edge_follow']['count'],
		'PAYLAŞILAN FOTOĞRAF SAYISI': js['edge_owner_to_timeline_media']['count'],
		'PAYLAŞILAN VİDEO SAYISI': js['edge_felix_video_timeline']['count'],
		'REELS': js['highlight_reel_count'],
		'BİYOGRAFİ': js['biography'].replace('\n', ', '),
		'BİYOGRAFİ URL': js['external_url'],
		'GİZLİ HESAP MI ': js['is_private'],
		'ONAYLI HESAP MI ': js['is_verified'],
		'PROFİL FOTOĞRAFI': urlshortner(js['profile_pic_url_hd']),
		'İŞ HESABI MI ': js['is_business_account'],
		#'connected to fb': js['connected_fb_page'],  -- requires login
		'YENİ Mİ KATILDI': js['is_joined_recently'],
		'İŞ KATAGORİSİ': js['business_category_name'],
		'KATAGORİ': js['category_enum'],
		'KILAVUZ VAR MI ': js['has_guides'],
	}
